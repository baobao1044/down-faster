...
| Claim | How to check |
|---|---|
| 457 tests pass, 0 fail, 0 skip, in about a second | `npm test` |
...
test/                     12 files, 457 tests, node:test
...
457 passing tests do not mean a working download, and the project would rather say so
